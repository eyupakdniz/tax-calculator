...
class TaxServiceTest {
    ...
    @Test
    void testCreateTaxError() {
        // Arrange
        CreateTaxRequestDTO requestDTO = new CreateTaxRequestDTO("", 0.18); // Boş isim

        // Act & Assert
        assertThrows(IllegalArgumentException.class, () -> taxService.createTax(requestDTO));
    }
